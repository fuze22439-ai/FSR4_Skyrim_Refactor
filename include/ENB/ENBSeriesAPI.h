...
namespace ENB_API
{
	...
	public:
		...
		typedef TwType (*_TwDefineStruct)(const char* name, const TwStructMember* structMembers, unsigned int nbMembers, size_t structSize, TwSummaryCallback summaryCallback, void* summaryClientData);
		...
		{
			return reinterpret_cast<_TwDefineStruct>(GetProcAddress(enbmodule, "TwDefineStruct"))(name, structMembers, nbMembers, structSize, summaryCallback, summaryClientData);
		}
	...
	static inline void* RequestENBAPI(const SDKVersion a_ENBSDKVersion = SDKVersion::V1001)
	{
